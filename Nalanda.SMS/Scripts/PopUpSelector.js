                    ...
                    if ($this.SortBy == col) {
                        if ($this.InReverse) {
                            tbl += '<th class="' + 'ui-table-sort-down' + '" data-columns-sortby="' + col + '">' +
                                col.replace(re47, '/').replace(re, ' ') + ' <span class="glyphicon glyphicon-sort-by-attributes-alt"></span></th>';
                        } else {
                            tbl += '<th class="' + 'ui-table-sort-up' + '" data-columns-sortby="' + col + '">' +
                                col.replace(re47, '/').replace(re, ' ') + ' <span class="glyphicon glyphicon-sort-by-attributes"></span></th>';
                        }
                    } else {
