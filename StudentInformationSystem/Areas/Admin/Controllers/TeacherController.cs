        ...
        public ActionResult Create(TeacherVM teacher)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    AddAlert(AlertStyles.success, "Teacher Information Created Successfully.");
        ...
        public ActionResult ChildCreate(TeacherSubjectVM vm)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    AddAlert(AlertStyles.success, "Teacher Subject Added Successfully.");
        ...
        public ActionResult ChildEdit(TeacherSubjectVM vm)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    AddAlert(AlertStyles.success, "Teacher Subject Modified Successfully.");
                    string url = Url.Action("ChildIndex", new { id = vm.Id, isToEdit = true });
