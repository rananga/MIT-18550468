...
namespace StudentInformationSystem.Areas.Base
{
    ...
    public class BaseController : Controller
    {
        ...
        public void ShowConcurrencyErrors(DbUpdateConcurrencyException UpdConcEx, bool forDelete = false)
        {
            ...
            {
                if (forDelete)
                { AddAlert(AlertStyles.danger, "The record you attempted to delete was deleted by another user."); }
                else
            ...
            if (forDelete)
            {
                AddAlert(AlertStyles.danger, "The record you attempted to delete "
